...
import { Text, View, TextInput, StyleSheet, Platform, StatusBar, SafeAreaView, ImageBackgrounda, ImageBackground, Touchable } from 'react-native';
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: "#1a0023" }}>
             ...
             <Text style={{textAlign:'center', color:"#12948840", fontWeight:'bold',
